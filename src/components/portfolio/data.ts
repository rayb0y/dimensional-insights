...
export const layers: Layer[] = [
  ...
  },
  {
    ...
    accent: ACCENT.coral,
    label: "Reform",
    eyebrow: "EY Global Delivery Services  ·  Consultant  ·  Change Management  ·  2023–2024",
    title: "Reform",
    paragraphs: [
      "A change management system built entirely in PowerApps — tracking culture shift initiatives across business functions for a large enterprise client. Editable columns with Excel-like inline editing, full-database search across a live SQL database, and role-based views for each stakeholder group.",
      "The brief was a tracking tool. What it became was a study in how information architecture determines whether people actually use a system or quietly work around it. Reform went through multiple complete rebuilds before the hierarchy was right.",
    ],
    insight: "Information architecture is the difference between a tool people use and a tool they avoid.",
    tags: ["PowerApps", "SQL", "Change Management", "Information Architecture", "EY"],
  },
  {
    id: "eye",
    accent: ACCENT.coral,
    label: "Eye",
    eyebrow: "EY Global Delivery Services  ·  Associate Consultant  ·  Compliance Monitoring  ·  2022–2023",
    title: "Eye",
    paragraphs: [
      "A Business As Usual compliance monitoring system tracking regulatory data across 21+ policies. Built in PowerApps to replace a manual daily process that no one wanted to run — the kind of task that exists because no one has yet bothered to make it easier.",
      "From day one the goal was to make it considered — something that felt worth opening. The same screen went through twelve complete iterations before one was right. I didn't know then that that was what building good tools looked like. It was the first time I did it on instinct.",
    ],
    insight: "I made the same screen twelve times. The twelfth one was right.",
    tags: ["PowerApps", "Compliance", "Iterative Development", "EY"],
  },
  {
    id: "dark",
